      ...
      <div
        ...
        className={`flex flex-col items-center justify-center p-5 border-2 border-dashed rounded-xl cursor-pointer transition-all ${
          isDragging
            ...
            : "border-gray-300 bg-white hover:bg-gray-50/80 hover:border-[#7BBCE7]"
        }`}
      >
        {/* Upload Icon */}
        ...
        {uploadLicense ? (
          ...
          <p className="text-sm font-medium text-gray-600 text-center">
            Click to upload or drag & drop reports or scans <br /> (PDF, JPEG, DICOM, max 50MB)
          </p>
        )}
      </div>
    </div>
