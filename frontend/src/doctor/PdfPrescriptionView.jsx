...
export default function PdfPrescriptionView() {
  ...
  const fetchPrescription = useCallback(async () => {
    try {
      ...
      const response = await axios.get(`${baseUrl}/api/doctor/prescription-details/${prescriptionId}`);
  ...
  if (!data) {
    return (
      <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center font-sans text-slate-600 gap-4">
        <p>Prescription details could not be found.</p>
        <button
          type="button"
