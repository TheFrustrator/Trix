...
export default function PdfPrescriptionView() {
  ...
  const role = ["patient", "pharmacy"].includes(requestedRole)
    ? requestedRole
    : "doctor";
  ...
  const fetchPrescription = useCallback(async () => {
    try {
      ...
      const endpoint =
        role === "pharmacy"
          ? `${baseUrl}/api/pharmacy/prescription/${prescriptionId}`
          : `${baseUrl}${apiBase}/prescription-details/${prescriptionId}`;
      ...
      if (response.data.success && response.data.prescriptionData) {
        ...
        setError(
          response.data.message ||
            "Prescription data was empty in the server response.",
        );
      }
    } catch (err) {
  ...
  }, [backendUrl, prescriptionId, apiBase, role]);
    ...
    <div className="min-h-screen bg-gray-100 p-4 md:p-8 flex flex-col justify-center items-center font-sans">
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-4 text-sm mb-6">
          ...
          <div className="space-y-1 text-slate-700">
            ...
            <p>
              ...
              <span className="font-mono">{patient.patientCustomId}</span>
            </p>
            <p>
        ...
        <div className="mb-6">
          ...
          <p className="italic text-slate-800 text-sm whitespace-pre-line leading-relaxed">
            {data.notes}
          </p>
        </div>
        ...
        <div className="flex justify-between items-end pt-4 border-t border-gray-100">
          ...
          <div className="flex flex-col items-center">
            <span className="font-serif text-3xl italic text-slate-800 select-none tracking-wide mb-1">
              {doctor.name}
            </span>
